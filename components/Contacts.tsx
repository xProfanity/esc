    ...
    <section className="h-screen w-full mt-56">
        <div className="h-[50rem] lg:h-[35rem] container mx-auto flex flex-col lg:flex-row items-center justify-center">
            <div className="h-full w-full flex flex-col justify-center md:justify-start items-center md:items-start">
                ...
                <p className="mt-5 font-semibold text-base sm:text-lg font-mont text-[#CCCCCC] w-2/3 text-center md:text-left">Have questions or want to get involved? Reach out to us! We're here to listen, assist, and collaborate.</p>
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-2 mt-10">
                       <svg className="h-6 w-6 text-red-500"
                        ...
                        <p className="text-white font-mont font-bold text-center md:text-left text-base md:text-lg">Plot No 228, Jacaranda Avenue, Mandala, Blantyre, Malawi.</p>
                </div>
                <div className="flex flex-col md:flex-row justify-center items-center gap-2 mt-5">
                    ...
                    <p className="text-white font-mont font-bold text-center md:text-left text-base md:text-lg">P.O Box 333, Blantyre, Malawi.</p>
                </div>
            </div>
