    ...
    <section className="h-screen w-full">
      <div className="container h-[90%] mx-auto flex flex-row justify-between items-center gap-2 bg-primary rounded-3xl">
        <div className="h-full w-full">
          <h1 className="mt-10 ml-6 text-6xl font-extrabold font-mont text-[#0c0c0c]">Vision & Funding</h1>
          <p className="mt-5 ml-6 font-semibold text-lg font-mont text-[#0c0c0c]">Explore Our Vision and Support Us. Learn How Your Contribution Can Make a Difference in Environmental Preservation, Social Justice, and Cultural Sustainability. Get Involved Today!</p>
          ...
          <div className="w-full flex flex-row justify-around items-center mt-10">
            ...
            <div className="flex flex-col w-full justify-evenly items-start gap-2 h-[15rem]">
              ...
              <p className="font-semibold w-4/5 mx-auto text-justify text-lg font-mont text-white">Seeking funding from government, overseas donors, and interested organizations.</p>
            </div>
        ...
        <div className="h-[90%] w-full flex flex-col justify-center items-center">
          <div className="relative h-[760px] w-[400px]">
            <Image
              src={huddle}
              fill
              alt="desk"
