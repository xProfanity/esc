...
export default function Missions() {
  return (
    <section className="h-screen w-full py-12">
        <div className="container h-full mx-auto flex flex-col justify-start items-center">
            <div className="flex">
                <p>header</p>
            </div>
            <div className="flex flex-col lg:flex-row justify-start items-start gap-10 md:gap-4 w-fit">
                <div className="h-full w-full">
                    <div className={`h-[390px] sm:h-[400px] md:h-[450px] lg:h-[400px] xl:h-[450px] w-[440px] sm:w-[450px] md:w-[600px] lg:w-[450px] xl:w-[600px] bg-primary rounded-3xl relative overflow-hidden`}>
                        <div className="h-32 ml-5 flex flex-col justify-center items-start mt-10">
                            <p className="text-5xl xl:text-6xl font-extrabold sm:text-amber-500 md:text-orange-500 lg:text-accent xl:text-[#0c0c0c] font-mont">Our Missions</p>
                        </div>
                        ...
                        <div className={`ml-5 flex flex-row justify-start items-center gap-2`}>
                            ...
                            <p className={`font-semibold text-lg font-mont text-[#0c0c0c]`}>Strive towards sustenance in Climate Change & Environment.</p>
                        </div>
                ...
                <div className="h-full w-full flex flex-col justify-between gap-10 md:gap-2">
                    <div className={`w-[450px] md:w-[600px] lg:w-[450px] xl:w-[600px] h-[195px] md:h-[217px] lg:h-[195px] xl:h-[217px] bg-primary rounded-3xl relative overflow-hidden`}>
                        <div className={`absolute w-1/2 h-full top-2 flex flex-col gap-2 left-2`}>
                            ...
                            <p className={`w-11/12 font-semibold text-lg font-mont text-[#0c0c0c]`}>Counter Socio-Economic issues and Corruption.</p>
                        </div>
                    ...
                    <div className={`w-[450px] md:w-[600px] lg:w-[450px] xl:w-[600px] h-[195px] md:h-[217px] lg:h-[195px] xl:h-[217px] bg-primary rounded-3xl relative overflow-hidden`}>
                        <div className={`absolute w-1/2 h-full top-2 flex flex-col gap-2 -right-2`}>
                            ...
                            <p className={`w-11/12 font-semibold text-lg font-mont text-[#0c0c0c]`}>Participate in fighting pandemics and disasters.</p>
                        </div>
